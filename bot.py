    ...
    def __init__(self, msg):
        ...
        self.messages = {
            'start':'🤖 Hello, '+ self.user_name +'!\n\n'
                    '📩 Kirimkan saya:\n\n'
                    '"*/music* _judul lagu_"  atau\n'
                    '"*/music* _nama musisi - judul lagu_"\n\n'
                    'untuk memesan beberapa musik. 🎶', 

            'spotify_input_error':"‼️ *Oops! Bot tidak mendukung tautan Spotify!*\n"
                    'Coba: "*/music* _judul lagu_"\n'
                    'atau: "*/music* _nama musisi - judul lagu_"',

            'invalid_command':'‼️ *Oops! Perintah tidak valid!*\n'
                    'Coba: "*/music* _judul lagu_"\n'
                    'atau: "*/music* _nama musisi - judul lagu_"',

            'too_long':'‼️ *Oops! Video terlalu panjang untuk dikonversi!*\n'
                    'Pesan sesuatu yang berdurasi 30 menit atau kurang.'
        }
